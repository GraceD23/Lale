...
function attachKeypadHandlers() {
  ...
  keypadButtons.forEach(function (button) {
    /* Use touchstart for instant response across the full bubble on iPhone.
       Falls back to click on desktop. */
    button.addEventListener("touchstart", function (e) {
      e.preventDefault(); /* prevents double-firing with click and stops zoom */
